...
- Current preview authentication is Turkish phone number plus password; SMS OTP is deferred but retained for a later phase. Do not add Google sign-in. Keep development-only identity headers disabled in production.
